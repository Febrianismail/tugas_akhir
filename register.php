          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="main/img/tlogo.png" width="150" height="150" alt="logo">
              </div>
              ...
              <form method="POST" class="pt-3">
                ...
                <div class="form-group">
                  <input type="date" name="tgl" class="form-control form-control-lg" placeholder="Tanggal Lahir Anda" required>
                </div>
                <div class="form-group">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/surattlogomas/">BATAL</a>
                </div>
