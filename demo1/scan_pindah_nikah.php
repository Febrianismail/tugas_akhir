            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">PERSYARATAN REQUEST SURAT PINDAH NIKAH</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <?php
                            include '../konek.php';
                            //session_start();
                            $tampilkandatasktm = "SELECT * FROM t_pindah_nikah WHERE nik=$_SESSION[nik_pindah_nikah]";

                            // nik ganti session

                            $query = mysqli_query($konek, $tampilkandatasktm);
                            $datasktm = mysqli_fetch_array($query, MYSQLI_BOTH);

                            $nik = '';
                            $idpindahnikah = '';
                            if (isset($datasktm)) {
                                $nik = $datasktm['nik'];
                                $idpindahnikah = $datasktm['id_pindah_nikah'];
                            }
                            ...
                            $tampilScan = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `pindah_nikah_id`= $idpindahnikah ";
                            ...
                            <div class="container mt-5">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">Scan Keterangan Asal usul dari RT/RW</li>
                                    <li class="list-group-item">Scan Keterangan Asal usul dari RT/RW</li>
                            ...
                            <div class="container mt-5">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <a href="?halaman=request_pidah_nikah" class="btn btn-secondary">Kembali</a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="../dataFoto/<?= $vScans['path_image'] ?>" alt="" class="img-thumbnail" style="width: 20%;">
                                                </td>
                                                <td>
                                                    <a href="?halaman=scanpindahnikah&delete=<?= $vScans['idImage'] ?>" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            if (isset($_POST['tambah'])) {
                                ...
                                if (!empty($jenisPersyaratan)) {
                                    ...
                                    $querySimpanScan = "INSERT INTO `data_image` (`pindah_nikah_id`, `jenis_surat_id`, `path_image`) VALUES ('$idpindahnikah','$jenisPersyaratan', '$file_name') ";
                                    ...
                                    echo '<meta http-equiv="refresh" content="0; url=?halaman=scanpindahnikah">';
                                } else {
