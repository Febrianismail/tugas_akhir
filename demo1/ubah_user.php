							...
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group">
									...
									<select name="status_warga" class="form-control">
										...
										<option value="Pelajar/Mahasiswa" <?php if ($status_warga == "Sekolah") echo 'selected' ?>>Pelajar/Mahasiswa</option>
										<option value="BeKerja" <?php if ($status_warga == "Kerja") echo 'selected' ?>>Kerja</option>
										<option value="Belum Bekerja" <?php if ($status_warga == "Belum Kerja") echo 'selected' ?>>Belum Kerja</option>
									</select>
								</div>
								<div class="form-group">
									...
									<select name="status_perkawinan" class="form-control">
										...
										<option value="Belum Menikah" <?php if ($status_perkawinan == "Belum Menikah") echo 'selected' ?>>Belum Menikah</option>
										<option value="Menikah" <?php if ($status_perkawinan == "Sudah") echo 'selected' ?>>Menikah</option>
									</select>
								</div>
								<div class="form-group">
									<label>Password</label>
								...
								<div class="form-group">
									...
									<select name="hak_akses" class="form-control">
										...
										<option value="Pemohon" <?php if ($hak_akses == "Pemohon") echo 'selected' ?>>Pemohon</option>
										<option value="Lurah" <?php if ($hak_akses == "Lurah") echo 'selected' ?>>Sekdes</option>
										<option value="Staf" <?php if ($hak_akses == "Staf") echo 'selected' ?>>Staf</option>
									</select>
								</div>
							</div>
...
if (isset($_POST['ubah'])) {
	...
	password='$password',
	hak_akses='$hak_akses',status_perkawinan='$status_perkawinan' WHERE nik=$nik";
	$query = mysqli_query($konek, $sql);
