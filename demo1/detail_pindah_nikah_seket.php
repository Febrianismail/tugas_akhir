                ...
                <div class="card">
                    <div class="card-header">
                        <div class="form-group">
                            ...
                            <a href="?halaman=belum_acc_pindah_nikah" class="btn btn-info btn-border btn-round btn-sm">
                                Batal
                            </a>
                        </div>
                    </div>
...
if (isset($_POST['ubah'])) {
    ...
    if ($query == 1) {
        ...
        if ($quey == 1) {
            ...
            echo '<meta http-equiv="refresh" content="3; url=?halaman=acc_pindah_nikah">';
        }
    } else {
