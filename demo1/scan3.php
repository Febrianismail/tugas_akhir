            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">PERSYARATAN SURAT PERNYATAAN</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <?php
                            include '../konek.php';
                            //session_start();
                            $tampilkandatapernyataan = "SELECT * FROM t_pernyataan WHERE nik=" . $_SESSION['nik_sp'] . " ORDER BY id_pernyataan desc";

                            // nik ganti session

                            $query = mysqli_query($konek, $tampilkandatapernyataan);
                            $datapernyataan = mysqli_fetch_array($query, MYSQLI_BOTH);


                            $nik = '';
                            $idpernyataan = '';
                            if (isset($datapernyataan)) {
                                $nik = $datapernyataan['nik'];
                                $idpernyataan = $datapernyataan['id_pernyataan'];
                            }
                            ...
                            $tampilScan = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `pernyataan_id`= $idpernyataan ";
                            ...
                            <div class="container mt-5">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <a href="?halaman=request_sp" class="btn btn-secondary">Kembali</a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="../dataFoto/<?= $vScans['path_image'] ?>" alt="" class="img-thumbnail">
                                                </td>
                                                <td>
                                                    <a href="?halaman=scan3&delete=<?= $vScans['idImage'] ?>" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            if (isset($_POST['tambah'])) {
                                ...
                                if (!empty($jenisPersyaratan)) {
                                    ...
                                    $querySimpanScan = "INSERT INTO `data_image` (`pernyataan_id`, `jenis_surat_id`, `path_image`) VALUES ('$idpernyataan','$jenisPersyaratan', '$file_name') ";
