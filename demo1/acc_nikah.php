            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="fw-bold text-uppercase">TAMPIL ACC REQUEST NIKAH</h4>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" name="check[$i]" value="<?php echo $id_nikah; ?>">
                                                <input type="submit" name="acc" class="btn btn-primary btn-sm" value="ACC">
                                                <div class="form-button-action">
                                                    <a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Cek Data" href="?halaman=detail_nikah&id_nikah=<?= $id_nikah; ?>">
...
if (isset($_POST['acc'])) {
    if (isset($_POST['check'])) {
        foreach ($_POST['check'] as $value) {
            ...
            $ubah = "UPDATE t_nikah SET `status`='1', `keterangan`='$ket', `acc`='$tgl' WHERE id_nikah=" . $value;
