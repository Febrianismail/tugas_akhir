			...
			<form method="POST">
				<div class="card">
					<div class="card-header">
						...
						<i> Isi data ini yang lengkap dan benar</i>
					</div>
					<div class="card-body">
						<div class="row">
								...
								<div class="form-group">
									...
									<select name="agama" class="form-control">
										...
										<option <?php if ($agama == 'Kristen') {
													echo "selected";
												} ?> value='Kristen'>Kristen Prosete</option>
...
if (isset($_POST['ubah'])) {
	...
	alamat='$alamat',
	telepon='$telepon',
	status_warga='$status_warga',status_perkawinan='$status_perkawinan'
