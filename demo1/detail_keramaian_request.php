            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">DETAIL EDIT REQUEST SURAT KERAMAIAN</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        $idParamsUrl = $paramValuesId['id_keramaian'];
                        ...
                        $idSktm = '';
                        if (isset($paramValuesId['id_keramaian'])) {
                            $idSktm = $paramValuesId['id_keramaian'];
                        }

                        $tampilScan = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `keramaian_id`=" . $idSktm;
                                ...
                                <tbody>
                                    <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?halaman=detail_keramaian_request&delete=<?= $vScans['idImage'] ?>&id_keramaian=<?= $idSktm ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            if (!empty($jenisPersyaratan)) {
                                ...
                                $querySimpanScan = "INSERT INTO `data_image` (`keramaian_id`, `jenis_surat_id`, `path_image`) VALUES ('$idParamsUrl','$jenisPersyaratan', '$file_name') ";
                                ...
                                echo '<meta http-equiv="refresh" content="0; url=?halaman=detail_keramaian_request&id_keramaian=' . $idParamsUrl . '">';
                            } else {
