            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">DETAIL EDIT REQUEST SKCK</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        $tampilScan = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `skck_id`=" . $paramValuesId['id_skck'];
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            if (!empty($jenisPersyaratan)) {
                                ...
                                $querySimpanScan = "INSERT INTO `data_image` (`skck_id`, `jenis_surat_id`, `path_image`) VALUES ('$idSkdu','$jenisPersyaratan', '$file_name') ";
