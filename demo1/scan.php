            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">PERSYARATAN REQUEST SURAT KETERANGAN DOMISILI USAHA</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <?php
                            ...
                            if (isset($_POST['tambah'])) {
                                ...
                                if (!empty($jenisPersyaratan)) {
                                    ...
                                    $querySimpanScan = "INSERT INTO `data_image` (`skdu_id`, `jenis_surat_id`, `path_image`) VALUES ('$idSkdu','$jenisPersyaratan', '$file_name') ";
