			...
			<form method="POST" enctype="multipart/form-data">
				<div class="card">
					<div class="card-header">
						<div class="card-title">FORM REQUEST SKTM</div>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group">
									...
									<input type="hidden" class="form-control" value="<?= $tempat; ?>">
								...
								<div class="form-group">
									...
									<input type="text" name="keperluan" class="form-control" placeholder="Keperluan Untuk Apa misal bpjs">
								</div>
								<div class="form-group">
									<label>Tujuan </label>
									<input type="text" name="tujuan" class="form-control" placeholder="tujuannya untuk apa mengajukan">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" name="keteranganrt_rw" class="form-control" placeholder="berdasarkan keterangan RT/RW isi">
								</div>
...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO t_sktm (nik,nama,nomorkk,tempat,tgl_lahir,jk,agama,status_perkawinan,pekerjaan,alamat,pendidikan,keperluan,tujuan,berlaku_tgl,berdasarkan_keterangan,nik_user) VALUES ('$nik','$nama','$nomorkk','$tempatlahir','$tgl','$jeniskelamin','$agama','$status_perkawinan','$pekerjaan','$alamat','$pendidikan', '$keperluan', '$tujuan', '$berlakutgl','$keterangan','$nikuser')";


	if ($konek->query($sql) === TRUE) {
		$_SESSION['nik_sktm'] = $nik;
		echo "<script language='javascript'>swal('Selamat...', 'Kirim Berhasil', 'success');</script>";
		echo '<meta http-equiv="refresh" content="3; url=?halaman=scansktm">';
		exit;
	} else {
