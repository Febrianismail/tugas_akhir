                ...
                <div class="card">
                    <div class="card-header">
                        <div class="form-group">
                            ...
                            <a href="?halaman=belum_acc_skd" class="btn btn-info btn-border btn-round btn-sm" align='center'>
                                Kembali
                            </a>
                        </div>
                    </div>
                    <div class="container mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label>NIK</label>
                                    <input type="number" name="nik" value="<?php echo $nik; ?>" class="form-control" placeholder="NIK Anda.." readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jk" value="<?php echo $kelamin; ?>" class="form-control" placeholder="Nama Lengkap Anda..">
                                </div>
...
if (isset($_POST['ubah'])) {
    ...
    if ($query == 1) {
        ...
        echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_skdu_seket">';
    }
}
?>