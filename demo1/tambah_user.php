...
if (isset($_POST['simpan'])) {
	...
	$sql = "INSERT INTO data_user (nik,password,hak_akses,nama,jekel,tempat_lahir,tanggal_lahir,status_warga,alamat,status_perkawinan) VALUES ('$nik','$password','$hak_akses','$nama','$jekel','$tempat','$tanggal','$status_warga','$alamat','$status_perkawinan')";
