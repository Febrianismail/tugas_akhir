                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" name="check[$i]" value="<?php echo $id_sktm; ?>">
                                                <input type="submit" name="acc" class="btn btn-primary btn-sm" value="ACC">
                                                <div class="form-button-action">
                                                    <a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Cek Data" href="?halaman=detail_sktm&id_sktm=<?= $id_sktm; ?>">
