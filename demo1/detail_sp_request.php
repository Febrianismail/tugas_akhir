            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">DETAIL EDIT REQUEST SURAT PERNYATAAN</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        $idpernyataan = '';
                        if (isset($paramValuesId['id_pernyataan'])) {
                            $idpernyataan = $paramValuesId['id_pernyataan'];
                        }
                                ...
                                <tbody>
                                    <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?halaman=detail_sp_request&delete=<?= $vScans['idImage'] ?>&id_pernyataan=<?= $idpernyataan ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            if (!empty($jenisPersyaratan)) {
                                ...
                                $querySimpanScan = "INSERT INTO `data_image` (`pernyataan_id`, `jenis_surat_id`, `path_image`) VALUES ('$paramValuesId[id_pernyataan]','$jenisPersyaratan', '$file_name') ";
                                ...
                                echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_sp_request&id_pernyataan=' . $paramValuesId['id_pernyataan'] . '">';
                            } else {
