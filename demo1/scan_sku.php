            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">PERSYARATAN REQUEST SURAT KETERANGAN USAHA</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <?php
                            include '../konek.php';
                            //session_start();
                            $tampilkandatasktm = "SELECT * FROM t_sku WHERE nik=$_SESSION[nik_sku]";
                            ...
                            $tampilScan = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `sku_id`= $idsku ";
                                    ...
                                    <tbody>
                                        <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?halaman=scansku&delete=<?= $vScans['idImage'] ?>" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            if (isset($_POST['tambah'])) {
                                ...
                                if (!empty($jenisPersyaratan)) {
                                    ...
                                    $querySimpanScan = "INSERT INTO `data_image` (`sku_id`, `jenis_surat_id`, `path_image`) VALUES ('$idsku','$jenisPersyaratan', '$file_name') ";
                                    ...
                                    echo '<meta http-equiv="refresh" content="0; url=?halaman=scansku">';
                                } else {
