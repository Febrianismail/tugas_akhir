            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        $idParamsUrl = $paramValuesId['id_sku'];
                        ...
                        $idSktm = '';
                        if (isset($paramValuesId['id_sku'])) {
                            $idSktm = $paramValuesId['id_sku'];
                        }

                        $tampilScan = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `sku_id`=" . $idSktm;
                                ...
                                <tbody>
                                    <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?halaman=detail_sku_request&delete=<?= $vScans['idImage'] ?>&id_sku=<?= $idSktm ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            if (!empty($jenisPersyaratan)) {
                                ...
                                $querySimpanScan = "INSERT INTO `data_image` (`sku_id`, `jenis_surat_id`, `path_image`) VALUES ('$idParamsUrl','$jenisPersyaratan', '$file_name') ";
                                ...
                                echo '<meta http-equiv="refresh" content="0; url=?halaman=detail_sku_request&id_sku=' . $idParamsUrl . '">';
                            } else {
