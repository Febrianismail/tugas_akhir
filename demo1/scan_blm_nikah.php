            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">PERSYARATAN REQUEST SURAT BELUM NIKAH</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <?php
                            include '../konek.php';
                            //session_start();
                            $tampilkandatasktm = "SELECT * FROM t_blm_nikah WHERE nik=$_SESSION[nik_blm_nikah]";
                            ...
                            $tampilScan = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `blm_nikah_id`= $idblmnikah ";
                            ...
                            <div class="container mt-5">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <a href="?halaman=request_nikah" class="btn btn-secondary">Kembali</a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?halaman=scanblmnikah&delete=<?= $vScans['idImage'] ?>" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            if (isset($_POST['tambah'])) {
                                ...
                                if (!empty($jenisPersyaratan)) {
                                    ...
                                    $querySimpanScan = "INSERT INTO `data_image` (`blm_nikah_id`, `jenis_surat_id`, `path_image`) VALUES ('$idblmnikah','$jenisPersyaratan', '$file_name') ";
                                    ...
                                    echo '<meta http-equiv="refresh" content="0; url=?halaman=scanblmnikah">';
                                } else {
