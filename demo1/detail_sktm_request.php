            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        $idParamsUrl = $paramValuesId['id_sktm'];
                        ...
                        $idSktm = '';
                        if (isset($paramValuesId['id_sktm'])) {
                            $idSktm = $paramValuesId['id_sktm'];
                        }
                                ...
                                <tbody>
                                    <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?halaman=detail_sktm_request&delete=<?= $vScans['idImage'] ?>&id_sktm=<?= $idSktm ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            if (!empty($jenisPersyaratan)) {
                                ...
                                $querySimpanScan = "INSERT INTO `data_image` (`sktm_id`, `jenis_surat_id`, `path_image`) VALUES ('$idParamsUrl','$jenisPersyaratan', '$file_name') ";
                                ...
                                echo '<meta http-equiv="refresh" content="0; url=?halaman=detail_sktm_request&id_sktm=' . $idParamsUrl . '">';
                            } else {
