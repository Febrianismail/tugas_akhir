            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">DETAIL EDIT REQUEST SURAT PINDAH NIKAH</div>
                    </div>
                    <div class="card-body">
                        <?php
                        include '../konek.php';
                        ...
                        $idParamsUrl = $paramValuesId['id_pindah_nikah'];
                        ...
                        $idNikah = '';
                        if (isset($idParamsUrl)) {
                            $idNikah = $paramValuesId['id_pindah_nikah'];
                        }

                        $tampilScan = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `pindah_nikah_id`=" . $idNikah;
                                ...
                                <tbody>
                                    <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?halaman=detail_pindah_nikah_request&delete=<?= $vScans['idImage'] ?>&id_pindah_nikah=<?= $idNikah ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            if (!empty($jenisPersyaratan)) {
                                ...
                                $querySimpanScan = "INSERT INTO `data_image` (`pindah_nikah_id`, `jenis_surat_id`, `path_image`) VALUES ('$idParamsUrl','$jenisPersyaratan', '$file_name') ";
                                ...
                                echo '<meta http-equiv="refresh" content="0; url=?halaman=detail_pindah_nikah_request&id_pindah_nikah=' . $idParamsUrl . '">';
                            } else {
