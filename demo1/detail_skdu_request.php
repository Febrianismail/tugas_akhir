            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">DETAIL EDIT REQUEST SURAT KETERANGAN DOMISILI</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        $idSkdu = '';
                        if (isset($paramValuesId['id_skdu'])) {
                            $idSkdu = $paramValuesId['id_skdu'];
                        }

                        $tampilScan = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `skdu_id`=" . $idSkdu;
                                ...
                                <tbody>
                                    <?php foreach ($dataScans as $keysScans => $vScans) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?halaman=detail_skdu_request&delete=<?= $vScans['idImage'] ?>&id_skdu=<?= $idSkdu ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            if (!empty($jenisPersyaratan)) {
                                ...
                                $querySimpanScan = "INSERT INTO `data_image` (`skdu_id`, `jenis_surat_id`, `path_image`) VALUES ('$paramValuesId[id_skdu]','$jenisPersyaratan', '$file_name') ";
                                ...
                                echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_skdu_request&id_skdu=' . $paramValuesId['id_skdu'] . '">';
                            } else {
