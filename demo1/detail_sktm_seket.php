...
$qDetailImg = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage, data_jenis_persyaratan.nama_persyaratan FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `sktm_id`=" . $paramValuesId['id_sktm'];
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="form-group">
                            <a href="?halaman=belum_acc_sktm" class="btn btn-info btn-border btn-round btn-sm">
                                Batal
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="berlakutgl" class="form-control" value="<?= $berlaku_tgl; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Berdasarkan Keterangan RT/RW</label>
                                    <input type="text" name="berdasarkan" class="form-control" value="<?= $berdasarkan_keterangan; ?>" readonly>
                                </div>
...
if (isset($_POST['ubah'])) {
    ...
    if ($query == 1) {
        $keterangan = $_POST['keterangan'];
        $ubah = "UPDATE t_sktm SET
		keterangan='$keterangan' WHERE id_sktm=" . $paramValuesId['id_sktm'];
        $quey = mysqli_query($konek, $ubah);
        if ($quey == 1) {
            echo "<script language='javascript'>swal('Selamat...', 'Ubah Berhasil', 'success');</script>";
            echo '<meta http-equiv="refresh" content="3; url=?halaman=acc_sktm">';
        }
    } else {
