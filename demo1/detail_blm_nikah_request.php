            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">DETAIL EDIT REQUEST SURAT BELUM NIKAH</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            if (!empty($jenisPersyaratan)) {
                                ...
                                $querySimpanScan = "INSERT INTO `data_image` (`blm_nikah_id`, `jenis_surat_id`, `path_image`) VALUES ('$idParamsUrl','$jenisPersyaratan', '$file_name') ";
