...
$qDetailImg = "SELECT *, data_jenis_persyaratan.id as idPersyaratan, data_image.id as idImage, data_jenis_persyaratan.nama_persyaratan FROM `data_image` JOIN data_jenis_persyaratan ON data_image.jenis_surat_id = data_jenis_persyaratan.id WHERE `pernyataan_id`=" . $paramValuesId['id_pernyataan'];
...
if (isset($_GET['id_pernyataan'])) {
    ...
    $tujuan = $data['untuk'];
    $pernyataan = $data['menyatakan_bahwa'];
}
?>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="form-group">
                            ...
                            <a href="?halaman=belum_acc_sp" class="btn btn-info btn-border btn-round btn-sm">
                                Batal
                            </a>
                        </div>
                    </div>
                    <div class="container mt-5">
                        <h1 class="mb-5">Formulir Data Pernyataan Pemohon</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Dengan Ini menyatakan </label>
                                    <input type="text" name="Tujuan" class="form-control" value="<?= $pernyataan; ?>" readonly>
                                </div>
                                <div class="form-group">
...
if (isset($_POST['ubah'])) {
    ...
    if ($query == 1) {
        $keterangan = $_POST['keterangan'];
        $ubah = "UPDATE t_pernyataan SET
		keterangan='$keterangan' WHERE id_pernyataan=" . $paramValuesId['id_pernyataan'];
        ...
        echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_sp">';
    }
}
?>