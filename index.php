...
<head>
    ...
    <title>Pelayanan Surat Keterangan Online Kelurahan Tlogomas</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/Group 1.png" width="150" height="75" alt="logo"></a>
                </div>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> KELURAHAN TLOGOMAS</h2>
                ...
                <img class="img-responsive wow fadeIn" src="main/images/cta2/" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
            </div>
        </div>
    </section>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh lurah, kemudian staf akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor Kelurahan Tlogomas.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <section id="contact">
        <div>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2489.3699730608446!2d112.60280111939139!3d-7.933821829966695!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e788210fb478a99%3A0xd042fc38003fae2a!2sKantor%20Kelurahan%20Tlogomas!5e0!3m2!1sid!2sid!4v1685858850752!5m2!1sid!2sid" width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi kelurahan"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y'); ?> KANTOR KELURAHAN TLOGOMAS KOTA MALANG
                </div>
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <li><a href="https://www.instagram.com/keltlogomas_malangkota/" target="_blank"><i class="fa fa-instagram"></i></a></li>
