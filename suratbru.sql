...
-- Dumping data for table surat.data_image: ~104 rows (approximately)
...
-- Dumping data for table surat.t_blm_nikah: ~2 rows (approximately)
REPLACE INTO `t_blm_nikah` (`id_blm_nikah`, `nama`, `nik`, `nomorkk`, `tempat_lahir`, `tgl_lahir`, `jk`, `agama`, `status_perkawinan`, `pekerjaan`, `alamat`, `pendidikan`, `keperluan`, `tujuan`, `berlaku_tgl`, `berdasrkan_keterangan`, `keterangan`, `acc`, `request`, `status`, `tanggal_request`, `nik_user`) VALUES
	...
	(4, 'rianasdas', '77721312', '123123', 'asdas', '2023-08-18', 'Perempuan', 'asdas', 'asdas', 'asdasd', 'asdas', 'asdas', 'asdas', 'asdad', '2023-08-18', 'asdasd', 'Surat sedang dalam proses cetak', '2023-08-26', NULL, 2, '2023-08-19 09:13:37', '777'),
...
-- Dumping data for table surat.t_keramaian: ~2 rows (approximately)
REPLACE INTO `t_keramaian` (`id_keramaian`, `nama`, `nomorkk`, `nik`, `tempat`, `tgl_lahir`, `jk`, `agama`, `status_perkawinan`, `pekerjaan`, `alamat`, `pendidikan`, `keperluan`, `tujuan`, `berlaku_tgl`, `acara`, `padatgl`, `keterangan`, `acc`, `request`, `status`, `tanggal_request`, `nik_user`) VALUES
	(4, 'rianasds', 'asdas', '77712312', 'asdas', '2023-08-18', 'Laki-Laki', 'asdasd', 'asdas', 'asdas', 'asdas', 'asd', 'asda', 'asdas', '2023-08-18', 'asdasd', '2023-08-18', 'Surat sedang dalam proses cetak', '2023-08-19', NULL, 2, '2023-08-19 12:40:52', '777'),
	...
	(9, 'febisama ', '21312', '1231231', 'jkt', '2001-12-12', 'Laki-Laki', 'islam', 'belum', 'buruh', 'la sucipto', 's1', 'acara keluarga', 'makan makan', '2023-08-19', 'pesta', '2023-08-30', 'Data sedang diperiksa oleh Staf', NULL, 'keramaian', 0, '2023-08-19 11:39:48', '123'),
...
CREATE TABLE IF NOT EXISTS `t_nikah` (
  ...
  `nama_lengkap_pria` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `nik_pria` varchar(17) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `tempat_lahir_pria` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `nama_wanita` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `nik_wanita` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `tempat_wanita` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `tgl_lahir_wanita` date DEFAULT NULL,
  `kewarganegaraan_wanita` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `agama_wanita` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `pekerjaan_wanita` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `alamat_wanita` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `status` int DEFAULT '0',
  `acc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `status_request` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `keterangan` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'Data sedang diperiksa oleh Staf',
  `request` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'nikah',
...
-- Dumping data for table surat.t_nikah: ~3 rows (approximately)
...
-- Dumping data for table surat.t_pernyataan: ~3 rows (approximately)
REPLACE INTO `t_pernyataan` (`id_pernyataan`, `nama`, `tempat`, `tgl_lahir`, `jenis_kelamin`, `nik`, `nomorkk`, `alamat`, `pekerjaan`, `menyatakan_bahwa`, `untuk`, `keterangan`, `acc`, `status`, `tanggal_request`, `keperluan`, `nik_user`, `request`) VALUES
	...
	(4, 'feb', 'jkt', '2001-12-12', 'laki-laki', '123', '1231', 'asdas', 'asdas', 'asdas', 'asdasd', 'Data sedang diperiksa oleh Staf', NULL, 0, '2023-08-19 06:53:42', 'asdas', '123', 'pernyataan'),
...
REPLACE INTO `t_pindah_nikah` (`id_pindah_nikah`, `nama`, `nomorkk`, `nik`, `jk`, `tempat`, `tgl_lahir`, `kebangsaan`, `agama`, `status_perkawinan`, `pekerjaan`, `alamat`, `pindahke`, `kelurahan`, `kecamatan`, `kab_kota`, `provinsi`, `keterangan`, `acc`, `request`, `status`, `tanggal_request`, `nik_user`, `tgl_nikah`, `berdasarkan`, `keperluan`) VALUES
	(5, 'feb', 'asdas', '123', 'Perempuan', 'asdas', '2001-12-12', 'asdas', 'asdas', 'asdasasdasd', 'asd', '   asdsa', 'asda', 'asd', 'asdas', 'asdas', 'asdaaacs', 'data belum lengkap', NULL, 'pindahnikah', 0, '2023-08-19 12:26:40', '123', '2023-08-18', 'cok', 'buatpindahnikah'),
	(6, 'rianasda', '12312', '77712312', 'Laki-Laki', 'asdasdas', '2023-08-10', 'asdas', 'asd', 'asda', 'asd', 'asd', 'asdas', 'asd', 'asdas', 'asd', 'asdas', 'Surat sedang diperiksa oleh sekertaris', '2023-08-19', 'pindahnikah', 1, '2023-08-19 10:07:05', '777', '2023-08-19', 'asdas', 'buatpindahnikah');
...
-- Dumping data for table surat.t_skck: ~4 rows (approximately)
...
-- Dumping data for table surat.t_skdu: ~8 rows (approximately)
...
-- Dumping data for table surat.t_sktm: ~0 rows (approximately)
...
-- Dumping data for table surat.t_sku: ~8 rows (approximately)
